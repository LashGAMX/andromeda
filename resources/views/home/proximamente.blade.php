...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{asset('img/logo.ico')}}" style="width:500%;height:auto;">
  ...
  <body onload="autoMusic()">
    ...
    <div class="container" id="content"> 
        <div class="row">
            <div class="col-12">
              <center><img id="imgMakeUp" src="{{asset('img/makeup.png')}}" class="img-fluid"></center>
          </div>
            <div class="col-12">
                <center><img id="imgProximamente" src="{{asset('img/proximamente.png')}}" class="img-fluid"></center>
            </div>
            ...
            <div class="col-12" id="footer">
              ...
              <audio id="fondoM" autoplay loop > 
                <source src="{{asset('sound/fondo.mp3')}}" type="audio/mpeg">
              </audio>
            </div>
        </div> 
  ...
  <script src='{{asset('js/mantenimiento.js')}}?v=0.0.2'></script> 
    <script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/3.9.1/gsap.min.js'></script>
    <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js'></script>
    <script src='{{asset('js/particulaMantenimiento.js')}}'></script> 
</html>   